...
export const checkWinner = (boardToCheck) => {
  ...
  for (let i = 0; i <= 6; i += 3) {
    if (
      ...
      boardToCheck[i] === boardToCheck[i + 2]) { return boardToCheck[i] }
  }

  if (boardToCheck[0] === boardToCheck[4] && boardToCheck[0] === boardToCheck[8]) { return boardToCheck[0] } else if (boardToCheck[2] === boardToCheck[4] && boardToCheck[2] === boardToCheck[6]) { return boardToCheck[2] }
